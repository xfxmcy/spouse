      ...
      <div class="header_images">
        <div class="gallery" id="slider">
           ...
           <#list bigPhoto as big>
            ...
            <li>
            	<img src="${r"${cy}"}/images/xiao.png" width="674" height="337" alt="xiao" /><br />
                <span><strong>晓</strong> from front to behind 迪达拉,带土,角都,飞段,小南,佩恩,大蛇丸or鼬,蠍,鬼鲛 </span>
            </li>
            <li>
            	<img src="${r"${cy}"}/images/zhangmen.jpg" width="674" height="337" alt="长门" /><br />
              	<span><strong>小南</strong> 弥彦 , 长门 </span>
            </li>
          </ul>
        </div>
      </div>
